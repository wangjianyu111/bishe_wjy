  ...
  <div class="register-page">
    ...
    <div class="register-left">
      ...
      <div class="form-container">
        ...
        <!-- 注册表单 -->
        <el-form :model="form" :rules="rules" ref="formRef" @submit.prevent class="register-form">
        ...
        <!-- 登录链接 -->
        <p class="login-link">已有账号？<router-link to="/login" class="login-link-text">立即登录</router-link></p>
      </div>
    </div>
